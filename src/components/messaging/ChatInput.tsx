...
const ChatInput = ({ isDisabled }: ChatInputProps) => {
  ...
  //find a specified html element dom node - using to set focus and keep it on input
  const textareaRef = useRef<HTMLTextAreaElement>(null);

  return (
    <div className="absolute bottom-0 left-0 w-full">
      <div className="xm-2 flex flex-row gap-3 md:mx-4 md:last:mb-6 lg:mx-auto lg:max-w-2xl lx:m-w-3xl">
